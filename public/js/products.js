...
const PRODUCTS = [
  ...
  { id:'furn-02', category:'furniture', name:'Rustic Iron-Leg Table', desc:'Petrified wood slab paired with black iron legs for an industrial-rustic look. 3D model generated with Meshy AI from a reference photo — under testing before a full licence purchase.',
    ...
    photo:null, spin:null, model:'/assets/models/furn-02-rustic-iron-leg-table-meshy.glb', ringSeed:2 },
  { id:'furn-03', category:'furniture', name:'Round Coffee Table', desc:'A round coffee table that follows the natural shape of the original fossilised trunk. 3D model generated with Meshy AI from a reference photo — under testing before a full licence purchase.',
    ...
    photo:null, spin:null, model:'/assets/models/furn-03-round-coffee-table-meshy.glb', ringSeed:3 },
  ...
  { id:'panel-02', category:'panel', name:'TV Backdrop Panel', desc:'A single large panel for a TV backdrop or feature wall.',
    ...
    photo:null, spin:null, model:null, ringSeed:5, soldOut:true },
  ...
  { id:'orn-01', category:'ornament', name:'Decorative Bowl', desc:'A turned decorative bowl from a solid block, showing the natural colour banding. 3D model generated with Meshy AI from a reference photo — under testing before a full licence purchase.',
    ...
    photo:null, spin:null, model:'/assets/models/orn-01-decorative-bowl-meshy.glb', ringSeed:6 },
  ...
  { id:'raw-02', category:'raw', name:'Whole Trunk Section', desc:'A section of fossilised trunk that still shows its original form in full.',
    ...
    photo:null, spin:null, model:null, ringSeed:10, soldOut:true },
  ...
  { id:'acc-01', category:'accessory', name:'Mini Fossil Pendant', desc:'A small collector-grade cut for a pendant necklace, with sharp amber tones.',
    ...
    photo:null, spin:null, model:null, ringSeed:11, soldOut:true },
